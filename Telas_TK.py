...
class SecondWindow(Toplevel):
    ...
    def bt_click3(self, button):
        ...
        if button['text'] == 'Limpar':
            ...
            '''
            self.lb_firstname = Label(self, text='')
            self.lb_secondname.delete(0, 'end')
            self.lb_date.delete(0, 'end')
            self.lb_gender.delete(0, 'end')
            self.lb_cpf.delete(0, 'end')
            self.lb_cel.delete(0, 'end')
            self.lb_email.delete(0, 'end')
            '''
    ...
    def __init__(self, master=None):
        ...
        self.lb_name_serch = Label(self, text='Localizar do Usuário')
        self.lb_name_serch["font"] = ("Arial", "10", "bold")
        self.lb_name_serch.place(x=30, y=70)

        self.ed_name_search = Entry(self, width=20)
    ...
    def bt_click2(self, button):
        ...
        if button['text'] == 'Localizar':
            ...
            for a in range(0, len(search)):
                ...
                date_month = search[a]['Date_month']
                date_year = search[a]['Date_year']
                geneder = search[a]['Gender']
                email = search[a]['Email']
                ...
                self.lb_gender = Label(self, text='Gênero:                           {}'.format(geneder))
                self.lb_gender.place(x=30, y=240)
                ...
                self.lb_email = Label(self, text='Email:                              {}'.format(email))
                self.lb_email.place(x=30, y=330)
